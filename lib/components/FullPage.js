...
var FullPage = /*#__PURE__*/function (_React$Component) {
  ...
  function FullPage(props) {
    ...
    _this.subscription = {
      next: _this.scrollNext,
      prev: _this.scrollPrev,
      moveTo: _this.scrollToSlide
    };
    _this.state = {
  ...
  _createClass(FullPage, [{
    ...
    value: function componentDidMount() {
      ...
      _services.SliderService.subscribe(this.subscription);
    ...
    value: function componentWillUnmount() {
      ...
      _services.SliderService.unsubscribe(this.subscription);
